...
const apiOperationsToTest: ApiTestOperation[] = JSON.parse('[{"apiId":"9C8592FF-AF09-EC11-949F-7085C23EF572","name":"SomeTestName","endpoint":"https://p9:8081/api/functions","method":"POST","path":"/Dictionary/List","type":"","data":"","headers":{},"parameters":{},"statusCode":"200","jestMaxRuntime":1000,"jestMatchName":"req.data","jestMatchOperation":"toBeTruthy","jestMatchValue":""}]');
